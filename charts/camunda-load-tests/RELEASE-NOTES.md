...
## [camunda-load-tests-0.1.13](https://github.com/camunda/camunda-load-tests-helm/compare/camunda-load-tests-0.1.12...camunda-load-tests-0.1.13) (2026-09-07)
...
* ignore saas-credentials checksum in golden tests
